...
<!DOCTYPE html>
<?php
$path = "http://localhost/tuan_viet_php/shopnew/admin/";
                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable"
                                ...
                                while ($row = $result->fetch_array()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?php echo $host . $row['avartar']; ?>"></td>
                                        <td nowrap="">
													<span class="dropdown">
														<a href="#"
														...
														<div class="dropdown-menu dropdown-menu-right"
                                                             ...
                                                             style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-32px, 26px, 0px);">
															<a class="dropdown-item"
                                                               href="edit.php?id=<?php echo $row['id']; ?>"><i
                                                                        class="la la-edit"></i> Edit</a>
															<a class="dropdown-item"
                                                               href="del.php?id=<?php echo $row['id']; ?>"><i
                                                                        class="la la-leaf"></i> Delete</a>
														</div>
													</span>
                                        </td>
                                    </tr>
