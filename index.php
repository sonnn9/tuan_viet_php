...
$url_sources = "http://localhost/home/";?>
...
<html lang="en">
	...
	<head>
		...
		<!--begin::Page Vendors -->
		<link href="<?php echo $url_sources;?>assets/vendors/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
						...
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
								<a href="javascript:;" class="m-menu__link m-menu__toggle">
									...
									<span class="m-menu__link-text">quản trị</span>
									<i class="m-menu__ver-arrow la la-angle-right"></i>
								</a>
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="basic/add.php" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">add_product</span>
														</a>
													</li>
													<li class="m-menu__item " aria-haspopup="true">
														<a href="basic/list.php" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">list_product</span>
														</a>
													</li>
												</ul>
											</div>
                                                ...
                                                <ul class="m-menu__subnav">
                                                    <li class="m-menu__item " aria-haspopup="true">
                                                        <a href="basic/add.php" class="m-menu__link ">
                                                            ...
                                                            <span class="m-menu__link-text">add_categories</span>
                                                        </a>
                                                    </li>
                                                    <li class="m-menu__item " aria-haspopup="true">
                                                        <a href="basic/list.php" class="m-menu__link ">
                                                            ...
                                                            <span class="m-menu__link-text">list_categories</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                                            ...
                                            <div class="m-menu__submenu ">
                                                ...
                                                <ul class="m-menu__subnav">
                                                    <li class="m-menu__item " aria-haspopup="true">
                                                        <a href="cbasic/add.php" class="m-menu__link ">
                                                            <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                                                <span></span>
                                                            </i>
                                                            <span class="m-menu__link-text">add_user</span>
                                                        </a>
                                                    </li>
                                                    <li class="m-menu__item " aria-haspopup="true">
                                                        <a href="basic/list.php" class="m-menu__link ">
                                                            ...
                                                            <span class="m-menu__link-text">list_user</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
