                ...
                <form class="m-form m-form--fit m-form--label-align-right">
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <input type="email" class="form-control m-input m-input--solid" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="form-group m-form__group">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <input type="password" class="form-control m-input m-input--solid" id="exampleInputPassword1">
                        </div>
                        <div class="form-group m-form__group">
                            <label>date</label>
                        ...
                        <div class="form-group m-form__group">
                            <label for="exampleSelect1">Product Groups</label>
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <textarea class="form-control m-input m-input--solid" id="exampleTextarea" rows="3"></textarea>
                        </div>
                    </div>
